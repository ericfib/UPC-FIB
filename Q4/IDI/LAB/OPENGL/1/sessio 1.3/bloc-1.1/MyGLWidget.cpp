...
void MyGLWidget::initializeGL ()
{
  ...
  // Inicialitzacions nostres
  factor = 0.5;
  glUniform1f(escalaLoc,factor);
...
void MyGLWidget::creaBuffers ()
{
  ...
  Colores[1] = glm::vec3 (0, 1, 0);
  Colores[2] = glm::vec3 (0, 1, 1);
...
// Metodes de transformacions -------------------------

// transformacions de model
...
void MyGLWidget::keyPressEvent (QKeyEvent *e) { 
    ...
    switch (e->key()) {
        ...
        case Qt::Key_D :
            if (factor > 0.15) {                       // evitem inversió
                factor -= 0.1;
                glUniform1f (escalaLoc, factor);
            }
            break;
        ...
        default: e->ignore(); //provoca que es torni a pintar l'escena
    }
    update ();
}    
